 ...
 */
interface ConcurrentIteratorInterface extends \IteratorAggregate
{
    /**
     ...
     *
     * @param CancellationInterface|null $cancellation Cancels waiting for the next value. If cancelled, the next value is not
